...
def test_converting_from_comic_info(files_folder: Path, output_folder: Path, metadata_validator: JsonValidator):
...
def test_converting_from_metron_info(files_folder: Path, output_folder: Path, metadata_validator: JsonValidator):
