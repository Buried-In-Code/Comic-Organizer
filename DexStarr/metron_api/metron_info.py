...
from DexStarr import ComicInfo, PublisherInfo, SeriesInfo, Settings
from DexStarr.comic_info import IdentifierInfo
from DexStarr.metron_api import Talker
...
def add_info(settings: Settings, comic_info: ComicInfo) -> ComicInfo:
    talker = Talker(settings.metron_username, settings.metron_password, SqliteCache("Dex-Starr-Cache.sqlite"))
